      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-primary-300 text-sm leading-relaxed">
              An informal initiative connecting hearts with homes. Visiting, caring, and supporting — one step at a time.
            </p>
            <p className="text-amber-400/80 text-xs mt-3 font-medium">
              Not a registered or certified organization.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={l.to}>
                  <Link to={l.to} className="text-primary-300 hover:text-amber-400 text-sm transition-colors">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <a
              ...
              className="flex items-center gap-2 text-primary-300 hover:text-amber-400 text-sm transition-colors mb-2"
            >
            ...
            <a
              ...
              className="flex items-center gap-2 text-primary-300 hover:text-amber-400 text-sm transition-colors"
            >
        ...
        <div className="border-t border-primary-800 mt-8 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-primary-400 text-xs text-center">
            Narkadhai is not a certified or registered nonprofit. Donations are voluntary and not tax-exempt.
          </p>
