  ...
  if (!album) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-24 text-center">
        ...
        <Link to="/albums" className="inline-flex items-center gap-2 bg-primary-700 hover:bg-primary-800 text-white font-medium px-5 py-2.5 rounded-xl transition-colors shadow-sm">
